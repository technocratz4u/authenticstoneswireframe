		          ...
		          <div class="row">
		            	...
		            	<div class="col-xs-12 col-md-6">
			            	...
			            	<p>We are one of Thailand's leading Gem Exporters of Precious & Semi Precious Colored Stones 
		            			...
		            			and Jaipur (Rajasthan) India.</p>
							<p>Authentic Stones Co., Ltd. has been operating globally since 1990 and specializing in all major shapes & sizes 
								(Cuts & Cabs: Rounds, Ovals, Pears, Octagons, Marquise, Taper/Baguette, Heart and etc.).</p>
							<p>We have a huge collection of Precious and Semi Precious Beads, Briolettes, Tumbles & Drops etc. 
								from Low to Top Quality.</p>
							<p>We are more than just a manufacturer - we re a one stop shop for all your specialized needs 
								viz. stones with specific shapes and sizes for watches and other accessories. With generations of 
								experience in the Gem & Jewelry Industry, Authentic Stones prides 
								itself on being the ultimate combination of "Quality, Style, Value & impeccable services worldwide".</p>
		            	</div>
		            </div>
		            <div class="row">
		            	<div class="col-xs-12">
		            ...
		            <div class="row">
		            	<div class="col-xs-12">
			            	...
			            	<p>Every attempt has been made to give an accurate description and photograph of each item. 
			            		We encourage you to send request to us for more details & price information regarding a specific product before you place your order. 
			            		We are sure you will be happy with your order. We cater to all market segments suiting all budgets & constraints.</p>
		            		<hr>
		            	</div>
		            </div>            
            </div>
