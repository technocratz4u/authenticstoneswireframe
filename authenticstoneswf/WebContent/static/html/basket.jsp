                        ...
                        <form method="post" action="checkout1.html">
                            ...
                            <div class="box-footer">
                                ...
                                <div class="pull-right">
                                    ...
                                    <button type="submit" class="btn btn-dark">Proceed to checkout <i class="fa fa-chevron-right"></i>
                                    </button>
                                </div>
                            </div>
                    ...
                    <div class="box">
                        ...
                        <form>
                            <div class="input-group">
								...
								<button class="btn btn-dark" type="button"><i class="fa fa-gift"></i></button>
